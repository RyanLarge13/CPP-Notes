...
private:
    ...
    string createUsername() {
        ...
        string confirm = ioHandler.getInput < string >({ {
         "Confirm " + RED + username + ENDCOLOR + " is the username you want"
        } }, YELLOW + "(Y/n): " + ENDCOLOR, "Please give a valid answer, Y for yes n for no");
    ...
    int createPin() {
        ...
        string confirm = ioHandler.getInput < string >({ {
         "Confirm " + RED + to_string(pin) + ENDCOLOR + " is what you want your new pin to be"
        } }, YELLOW + "(Y/n): " + ENDCOLOR, "Please provide a valid response, Y for yes, n for no");
        if (confirm == "Y" || confirm == "y") {
            return pin;
        }
        else {
...
public:
    ...
    void createAccount(ofstream* configFile) {
        ...
        string remoteAccount = ioHandler.getInput < string >({ {
         "This application is a sister application to Native Notes, and Electron Notes"
        } }, "Do you already have an existing account with one of these platforms?", "Pleas provide a valid answer");
